...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'new1_db.sqlite3'),
    }
}
...
DATE_FORMAT = 'Y-m-d'
DATETIME_FORMAT = 'Y-m-d H:00'  # No minutes or seconds, just the hour

# Set the input formats globally for forms
DATETIME_INPUT_FORMATS = ['%Y-%m-%d %H:00']
